...
//to print all the flights which come after 1150 where the maximum time is 2400

static void printgreaterthan(int32_t key,int32_t element,int32_t data[], uint32_t len) 
{   
    key=1150;
    if (element<=key) {
        return -1; }
